...
<head>
    ...
    <title>ZetaArcade || All Games</title>
</head>
<body>
        ...
        <div class="container">
            <div class="heading align-top trending h2 i">
                <h2 class="text-align-right">
                    <img src="https://img.icons8.com/nolan/64/crossed-axes.png"/>Action Games
                </h2>
            </div>
    ...
    <section class="all-games">
        <div class="container">
            <div class="heading align-top trending h2 i">
                <h2 class="text-align-right">
                    <img src="https://img.icons8.com/nolan/64/treasure-map.png"/>Adventure Games
                </h2>
            </div>
            <div class="all-games-grid">
                <div class="explore-box">
    ...
    <section class="all-games">
        <div class="container">
            <div class="heading align-top trending h2 i">
                <h2 class="text-align-right">
                    <img src="https://img.icons8.com/nolan/64/armored-helmet.png"/>RPG Games
                </h2>
            </div>
            <div class="all-games-grid">
                <div class="explore-box">
